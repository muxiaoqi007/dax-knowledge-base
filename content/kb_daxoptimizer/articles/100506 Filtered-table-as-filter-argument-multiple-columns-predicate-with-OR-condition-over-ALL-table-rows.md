---
title: "Filtered table as filter argument (multiple columns predicate with OR condition over ALL table rows)"
kb_id: "100506"
url: "https://kb.daxoptimizer.com/d/100506"
...
A [[FILTER]] function filtering [[ALL]] the rows of an entire table using an [OR](https://dax.guide/op/or/) condition on multiple columns is used as a filter argument in functions such as [[CALCULATE]], [[CALCULATETABLE]], etc.
