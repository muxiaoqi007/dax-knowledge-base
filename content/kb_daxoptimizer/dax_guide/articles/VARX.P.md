...
To compute the variance with a sample of the population, use [VARX.S](https://dax.guide/varx.s/).
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/varx-p-function-dax](https://docs.microsoft.com/en-us/dax/varx-p-function-dax?WT.mc_id=DP-MVP-4025372)
