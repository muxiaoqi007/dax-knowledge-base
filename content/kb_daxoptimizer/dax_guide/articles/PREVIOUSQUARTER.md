...
url: "https://dax.guide/previousquarter/"
source: "dax.guide"
重要度:
难度:
---

# PREVIOUSQUARTER DAX Function (Time Intelligence) Context Transition
...
The result includes all the days in the previous quarter considering the first day in the dates argument.
...
Internally, PREVIOUSQUARTER corresponds to the following call of [[PARALLELPERIOD]]:

```dax


PARALLELPERIOD ( FIRSTDATE ( <Dates> ), -1, QUARTER )

```

[» 1 related article](#articles)  
[» 9 related functions](#alt)  
...
| Selection | Previous Quarter |
| --- | --- |
| 91,636.30 | 2,738,040.73 |

## Related articles

Learn more about PREVIOUSQUARTER in the following articles:
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/previousquarter-function-dax](https://docs.microsoft.com/en-us/dax/previousquarter-function-dax?WT.mc_id=DP-MVP-4025372)
