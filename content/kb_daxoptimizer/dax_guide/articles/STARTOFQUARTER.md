...
url: "https://dax.guide/startofquarter/"
source: "dax.guide"
重要度:
难度:
---

# STARTOFQUARTER DAX Function (Time Intelligence) Context Transition
...
STARTOFQUARTER filters <Dates> into a 1-row, 1-column table that shows only the earliest date, in the entire <Dates> column devoid of all filters, that is in the same year and quarter as the earliest visible date in <Dates>.

The following STARTOFQUARTER call
...

{
    ...
    CALCULATE (
        ...
        CALCULATE (
            ...
            STARTOFQUARTER ( 'Date'[Date] )  -- 2007-04-01
...
Learn more about STARTOFQUARTER in the following articles:
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/startofquarter-function-dax](https://docs.microsoft.com/en-us/dax/startofquarter-function-dax?WT.mc_id=DP-MVP-4025372)
