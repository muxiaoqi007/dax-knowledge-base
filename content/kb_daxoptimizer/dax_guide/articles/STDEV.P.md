...
To compute the standard deviation with a sample of the population, use [STDEV.S](https://dax.guide/stdev.s/).

The STDEV.P function internally executes [STDEVX.P](https://dax.guide/stdevx.p/), without any performance difference.  
...
corresponds to the following [STDEVX.P](https://dax.guide/stdevx.p/) call:
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/stdev-p-function-dax](https://docs.microsoft.com/en-us/dax/stdev-p-function-dax?WT.mc_id=DP-MVP-4025372)
