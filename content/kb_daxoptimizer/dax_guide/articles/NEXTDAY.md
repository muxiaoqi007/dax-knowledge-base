...
url: "https://dax.guide/nextday/"
source: "dax.guide"
重要度:
难度:
---

# NEXTDAY DAX Function (Time Intelligence) Context Transition
...
The next day is evaluated considering the last day in the dates argument.
...
Internally, NEXTDAY corresponds to the following call of [[DATEADD]]:

```dax


DATEADD ( LASTDATE ( <Dates> ), 1, DAY )
...
--  NEXTDAY returns the day after the last day in the selection
...
Learn more about NEXTDAY in the following articles:
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/nextday-function-dax](https://docs.microsoft.com/en-us/dax/nextday-function-dax?WT.mc_id=DP-MVP-4025372)
