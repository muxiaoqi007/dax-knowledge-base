...
To compute the variance with the entire population, use [VAR.P](https://dax.guide/var.p/).

The VAR.S function internally executes [VARX.S](https://dax.guide/varx.s/), without any performance difference.  
...
corresponds to the following [VARX.S](https://dax.guide/varx.s/) call:
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/var-s-function-dax](https://docs.microsoft.com/en-us/dax/var-s-function-dax?WT.mc_id=DP-MVP-4025372)
