...
url: "https://dax.guide/previousday/"
source: "dax.guide"
重要度:
难度:
---

# PREVIOUSDAY DAX Function (Time Intelligence) Context Transition
...
The previous day is evaluated considering the first day in the dates argument.
...
Internally, PREVIOUSDAY corresponds to the following call of [[DATEADD]]:

```dax


DATEADD ( FIRSTDATE ( <Dates> ), -1, DAY )
    ...
    ROW (
        ...
        "Previous Day",
            ...
            CALCULATE (
                ...
                PREVIOUSDAY ( 'Date'[Date] ) -- 2008-08-14
...
| Selection | Previous Day |
| --- | --- |
| 91,636.30 | 18,266.23 |

## Related articles

Learn more about PREVIOUSDAY in the following articles:
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/previousday-function-dax](https://docs.microsoft.com/en-us/dax/previousday-function-dax?WT.mc_id=DP-MVP-4025372)
