...
url: "https://dax.guide/nextquarter/"
source: "dax.guide"
重要度:
难度:
---

# NEXTQUARTER DAX Function (Time Intelligence) Context Transition
...
Internally, NEXTQUARTER corresponds to the following call of [[PARALLELPERIOD]]:

```dax


PARALLELPERIOD ( LASTDATE ( <Dates> ), 1, QUARTER )
...
--  NEXTQUARTER returns the full quarter after the last day in the selection
    ...
    ROW (
        ...
        "Next Quarter",
            ...
            CALCULATE (
                ...
                NEXTQUARTER ( 'Date'[Date] ) -- 2008-10-01 : 2008-12-31
...
| Selection | Next Quarter |
| --- | --- |
| 91,636.30 | 2,797,611.46 |

## Related articles

Learn more about NEXTQUARTER in the following articles:
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/nextquarter-function-dax](https://docs.microsoft.com/en-us/dax/nextquarter-function-dax?WT.mc_id=DP-MVP-4025372)
