    ...
    "RT Customers",
        ...
        COUNTROWS (
            ...
            FILTER (
                ...
                Customer[Yearly Income] <= EARLIEST ( Customer[Yearly Income] )
...
--  EARLIEST is superseeded by a careful usage of variables.
...
Learn more about EARLIEST in the following articles:
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/earliest-function-dax](https://docs.microsoft.com/en-us/dax/earliest-function-dax?WT.mc_id=DP-MVP-4025372)
