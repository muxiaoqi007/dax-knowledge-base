...
url: "https://dax.guide/previousmonth/"
source: "dax.guide"
重要度:
难度:
---

# PREVIOUSMONTH DAX Function (Time Intelligence) Context Transition
...
The result includes all the days in the previous month considering the first day in the dates argument.
...
Internally, PREVIOUSMONTH corresponds to the following call of [[PARALLELPERIOD]]:

```dax


PARALLELPERIOD ( FIRSTDATE ( <Dates> ), -1, MONTH )
...
--  PREVIOUSMONTH returns the full month before the first day in the selection
    ...
    ROW (
        ...
        "Previous Month",
            ...
            CALCULATE (
                ...
                PREVIOUSMONTH ( 'Date'[Date] ) -- 2008-07-01 : 2008-07-31
...
| --- | --- |
| 91,636.30 | 890,547.41 |

## Related articles

Learn more about PREVIOUSMONTH in the following articles:
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/previousmonth-function-dax](https://docs.microsoft.com/en-us/dax/previousmonth-function-dax?WT.mc_id=DP-MVP-4025372)
