...
url: "https://dax.guide/endofmonth/"
source: "dax.guide"
重要度:
难度:
---
...
VAR DaysInMonth =
    ...
    FILTER (
        ...
        YEAR ( 'Date'[Date] ) = LastYearVisible
            ...
            && MONTH ( 'Date'[Date] ) = LastMonthVisible
...

{
    ...
    CALCULATE (
        ...
        CALCULATE (
            ...
            ENDOFMONTH ( 'Date'[Date] )  -- 2007-05-31
...
Learn more about ENDOFMONTH in the following articles:
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/endofmonth-function-dax](https://docs.microsoft.com/en-us/dax/endofmonth-function-dax?WT.mc_id=DP-MVP-4025372)
