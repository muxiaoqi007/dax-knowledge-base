...
url: "https://dax.guide/totalwtd/"
source: "dax.guide"
重要度:
难度:
---

# TOTALWTD DAX Function (Time Intelligence) Context Transition
...
A scalar value that represents the Expression evaluated for the Dates in the current week-to-date, given the selection in Calendar.
...
Microsoft documentation: [https://learn.microsoft.com/en-us/dax/totalwtd-function-dax](https://learn.microsoft.com/en-us/dax/totalwtd-function-dax?WT.mc_id=DP-MVP-4025372)
