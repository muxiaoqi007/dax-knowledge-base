...
url: "https://dax.guide/chisq-dist-rt/"
source: "dax.guide"
重要度:
难度:
---
...
If deg\_freedom < 1 or deg\_freedom > 10^10, CHISQ.DIST.RT returns the #NUM! error value.
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/chisq-dist-rt-function-dax](https://docs.microsoft.com/en-us/dax/chisq-dist-rt-function-dax?WT.mc_id=DP-MVP-4025372)
