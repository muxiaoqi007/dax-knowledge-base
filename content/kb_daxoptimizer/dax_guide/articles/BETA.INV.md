...
url: "https://dax.guide/beta-inv/"
source: "dax.guide"
重要度:
难度:
---

# BETA.INV DAX Function (Statistical)

Returns the inverse of the beta cumulative probability density function ([BETA.DIST](https://dax.guide/beta.dist/)). If probability = [BETA.DIST](https://dax.guide/beta.dist/)(x,…TRUE), then BETA.INV(probability,…) = x. The beta distribution can be used in project planning to model probable completion times given an expected completion time and variability.
...
Returns the inverse of the beta cumulative probability density function ([BETA.DIST](https://dax.guide/beta.dist/)).
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/beta-inv-function-dax](https://docs.microsoft.com/en-us/dax/beta-inv-function-dax?WT.mc_id=DP-MVP-4025372)
