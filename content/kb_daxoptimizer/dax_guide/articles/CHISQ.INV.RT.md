...
url: "https://dax.guide/chisq-inv-rt/"
source: "dax.guide"
重要度:
难度:
---

# CHISQ.INV.RT DAX Function (Statistical)

Returns the inverse of the right-tailed probability of the chi-squared distribution. If probability = [CHISQ.DIST.RT](https://dax.guide/chisq.dist.rt/)(x,…), then CHISQ.INV.RT(probability,…) = x. Use this function to compare observed results with expected ones in order to decide whether your original hypothesis is valid.
...
Given a value for probability, CHISQ.INV.RT seeks that value x such that [CHISQ.DIST.RT](https://dax.guide/chisq.dist.rt/)(x, deg\_freedom) = probability. Thus, precision of CHISQ.INV.RT depends on precision of [CHISQ.DIST.RT](https://dax.guide/chisq.dist.rt/). CHISQ.INV.RT uses an iterative search technique. If the search has not converged after 64 iterations, the function returns the #N/A error value.
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/chisq-inv-rt-function-dax](https://docs.microsoft.com/en-us/dax/chisq-inv-rt-function-dax?WT.mc_id=DP-MVP-4025372)
