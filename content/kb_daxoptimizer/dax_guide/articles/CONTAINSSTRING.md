...
url: "https://dax.guide/containsstring/"
source: "dax.guide"
重要度:
难度:
---
...
-- CONTAINSSTRING is syntax sugar for SEARCH
...
FILTER ( 
    ...
    CONTAINSSTRING ( 'Product'[Color], "r?y" ) 
...
FILTER (
    ...
    SEARCH ( "r?y", 'Product'[Color], 1, 0 ) > 0
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/containsstring-function-dax](https://docs.microsoft.com/en-us/dax/containsstring-function-dax?WT.mc_id=DP-MVP-4025372)
