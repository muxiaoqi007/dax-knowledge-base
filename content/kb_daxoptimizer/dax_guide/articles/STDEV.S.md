...
To compute the standard deviation with the entire population, use [STDEV.P](https://dax.guide/stdev.p/).

The STDEV.S function internally executes [STDEVX.S](https://dax.guide/stdevx.s/), without any performance difference.  
...
corresponds to the following [STDEVX.S](https://dax.guide/stdevx.s/) call:
...
Microsoft documentation: [https://docs.microsoft.com/en-us/dax/stdev-s-function-dax](https://docs.microsoft.com/en-us/dax/stdev-s-function-dax?WT.mc_id=DP-MVP-4025372)
